...
function getBotResponse(input) {
  ...
  } else if (inputText == "ethereum") {
    // price of ethereum
    return "<b>Ethereum : </b>" + eth + " $";
  } else if (inputText == "bitcoin") {
    // price of Bitcoin
    return "<b>Bitcoin :</b> " + btc + " $";
  } else if (inputText == "xrp" || inputText == "ripple") {
    //price of Ripple
    return "<b>Ripple : </b>" + xrp + " $";
  } else if (inputText == "binance" || inputText == "binance coin") {
    //price of binance coin
    return "<b>Binance Coin : </b>" + binance + " $";
  } else if (inputText == "cardano") {
    //price of cardano
    return "<b>Cardano : </b>" + card + " $";
  } else if (inputText == "polkadot") {
    //price of polkadot
    return "<b>Polkadot : </b>" + polka + " $";
  } else {
    // if, input no accepted
